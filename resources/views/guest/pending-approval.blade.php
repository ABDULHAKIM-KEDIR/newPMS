...
<style>
  ...
  .pending-card { width: 520px; max-width: 100%; padding: 36px 34px; }
  .pending-brand { display:flex; align-items:center; gap:10px; margin-bottom:26px; }
  ...
  .pending-alert p { margin:0; font-size:12.5px; color:var(--ink-soft); line-height:1.6; }
  .pending-info { margin-bottom:22px; }
  ...
  .pending-info li { display:flex; gap:10px; font-size:12.5px; color:var(--ink-soft); line-height:1.6; padding:6px 0; }
  .pending-info li::before { content:'›'; color:var(--accent); font-weight:600; }
  .pending-faq { border-top:1px solid var(--line); padding-top:16px; margin-bottom:22px; }
  .pending-faq details { margin-bottom:8px; }
  ...
  .pending-contact {
    padding:13px 14px; background:var(--surface-alt); border-radius:9px;
    font-size:11.8px; color:var(--ink-soft); line-height:1.65; margin-bottom:20px;
  }
