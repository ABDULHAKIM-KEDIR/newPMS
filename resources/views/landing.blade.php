    ...
    <div class="lp-hero-inner">
        ...
        <div>
            ...
            <h1>
                ...
                <span class="word accent-word"><span>clarity.</span></span>
            </h1>

            <p class="lead">
                Projects, phases, tasks, budgets, and teams — tracked in one place,
                from initiation to closure. No more status updates scattered across
                email, spreadsheets, and group chats.
            </p>
            ...
            <div class="lp-microstats">
                ...
                <div>
                    <span class="n" data-count="{{ $stats['projects'] }}">0</span>
                    <span class="l">Projects tracked</span>
                </div>
                ...
                <div>
                    <span class="n" data-count="{{ $stats['tasks_done'] }}">0</span>
                    <span class="l">Tasks completed</span>
                </div>

                <div>
                    <span class="n" data-count="{{ $stats['members'] }}">0</span>
                    <span class="l">Team members</span>
                </div>
        ...
        <div class="lp-hero-visual">
            ...
            <div class="lp-float-card c1">
                ...
                <div class="s">
                    ERP Migration crossed 70% utilisation
                </div>
            </div>
            ...
            <div class="lp-float-card c2">
                ...
                <div class="s">
                    marked "Migrate legacy records" as Done
                </div>
            </div>
...
<div class="lp-stats-strip" data-reveal-group>
    ...
    <div class="stat" data-reveal-item>
        <div class="n" data-count="{{ $stats['projects'] }}">0</div>
        <div class="l">Active &amp; past projects</div>
    </div>

    <div class="stat" data-reveal-item>
        <div class="n" data-count="{{ $stats['teams'] }}">0</div>
        <div class="l">Teams coordinated</div>
    </div>

    <div class="stat" data-reveal-item>
        <div class="n" data-count="{{ $stats['tasks_done'] }}">0</div>
        <div class="l">Tasks shipped</div>
    </div>

    <div class="stat" data-reveal-item>
        <div class="n" data-count="5">0</div>
        <div class="l">Lifecycle phases tracked</div>
    </div>
...
<section class="lp-section" id="features">
    ...
    <div class="lp-section-head" data-reveal>
        ...
        <p>
            Six pieces that replace the spreadsheets, email threads,
            and status meetings.
        </p>
    ...
    <div class="lp-features" data-reveal-group>
        ...
        <div class="lp-feature" data-reveal-item>
            ...
            <p>
                Every project moves through Initiation, Planning, Execution,
                Monitoring, and Closure — always visible at a glance.
            </p>
        </div>
        ...
        <div class="lp-feature" data-reveal-item>
            ...
            <p>
                Pending, in progress, done — with subtasks, dependencies,
                and threaded comments on every task.
            </p>
        </div>
        ...
        <div class="lp-feature" data-reveal-item>
            <div class="icon">
                <svg width="20" height="20" viewBox="0 0 24 24"
                    ...
                    <path d="M12 7v10M9.5 9.2c0-1.2 1.1-2 2.5-2s2.5.9 2.5 2c0 3-5 1.6-5 4.6 0 1.2 1.1 2 2.5 2s2.5-.8 2.5-2"/>
                </svg>
            </div>
            ...
            <p>
                Allocated vs. spent at both the project and phase level,
                with automatic utilisation alerts.
            </p>
        </div>
        ...
        <div class="lp-feature" data-reveal-item>
            ...
            <p>
                Teams, leads, and membership — with every project scoped
        ...
        <div class="lp-feature" data-reveal-item>
            ...
            <p>
                Every status change, approval, and edit logged — who did what,
                and when, always answerable.
            </p>
        </div>
...
<section class="lp-section lp-workflow" id="workflow">
    ...
    <div class="lp-section-head" data-reveal>
        ...
        <h2>
            One workflow, from kickoff to closure
        </h2>

        <p>
            Every project — software, network infrastructure, or training —
            moves through the same five stages, so status means the same
            thing everywhere.
        </p>
    ...
    <div class="lp-timeline" data-reveal-group>
        ...
        <div class="lp-timeline-item is-current" data-reveal-item>
            ...
            <div class="lp-timeline-card">
                <h5>
                    Initiation
                    <span class="lp-timeline-badge">Scope</span>
                </h5>

                <p>
                    Sponsor, scope statement, and success criteria are agreed
        ...
        <div class="lp-timeline-item" data-reveal-item>
            ...
            <div class="lp-timeline-card">
                <h5>
                    Planning
                    <span class="lp-timeline-badge">Budget &amp; team</span>
                </h5>

                <p>
                    Phases, budget allocation, and team assignments are locked
                    in before execution begins.
                </p>
            </div>
        </div>
        ...
        <div class="lp-timeline-item is-current" data-reveal-item>
            ...
            <div class="lp-timeline-card">
                <h5>
                    Execution
                    <span class="lp-timeline-badge">In progress</span>
                </h5>

                <p>
                    Tasks move across the Kanban board — pending, in progress,
                    done — with comments and dependencies tracked.
                </p>
            </div>
        </div>
        ...
        <div class="lp-timeline-item" data-reveal-item>
            ...
            <div class="lp-timeline-card">
                <h5>
                    Monitoring
                    <span class="lp-timeline-badge">Live tracking</span>
                </h5>

                <p>
                    Budget utilisation, risk, and change requests are tracked
                    continuously, not just at milestones.
                </p>
            </div>
        </div>
        ...
        <div class="lp-timeline-item" data-reveal-item>
            ...
            <div class="lp-timeline-card">
                <h5>
                    Closure
                    <span class="lp-timeline-badge">Sign-off</span>
                </h5>

                <p>
                    Deliverables are signed off and the project is archived,
                    with a full history intact.
                </p>
            </div>
        </div>
...
<section class="lp-section">
    ...
    <div class="lp-section-head" data-reveal>
        ...
        <p>
            The same views your team will use every day.
        </p>
    ...
    <div class="lp-gallery" data-reveal-group>
        ...
        <div class="lp-gallery-card lp-gradient-border" data-reveal-item>
            ...
            <div class="lp-gallery-head">
                <span>Budget overview</span>
                <span class="mono">68%</span>
            </div>

            <div class="lp-gallery-body">

                <div class="lp-mini-donut">
                    <span>68%</span>
                </div>

                <div class="lp-mini-bar">
                    <div style="width:92%; background:var(--success);"></div>
                </div>
                ...
                <div class="lp-mini-bar">
                    <div style="width:34%; background:var(--warning);"></div>
                </div>
        ...
        <div class="lp-gallery-card lp-gradient-border" data-reveal-item>
            ...
            <div class="lp-gallery-body">
                ...
                <div class="lp-mini-kanban">
                    ...
                    <div class="lp-mini-col">
                        <div class="h">Pending</div>
                        <div class="lp-mini-card">Security review</div>
                        <div class="lp-mini-card">UAT sign-off</div>
                    </div>

                    <div class="lp-mini-col">
                        <div class="h">Doing</div>
                        <div class="lp-mini-card">SSO integration</div>
                        <div class="lp-mini-card">Migrate records</div>
                    </div>

                    <div class="lp-mini-col">
                        <div class="h">Done</div>
                        <div class="lp-mini-card">Unit tests</div>
                    </div>
        ...
        <div class="lp-gallery-card lp-gradient-border" data-reveal-item>
            ...
            <div class="lp-gallery-body lp-audit-list">
...
<section class="lp-section lp-workflow" id="roles">
    ...
    <div class="lp-section-head" data-reveal>
        ...
        <p>
            Every account gets exactly the access their role needs —
            nothing more.
        </p>
...
<section class="lp-section">
    ...
    <div class="lp-testimonial-slider" id="lpTestimonials" data-reveal>
        ...
        <div class="lp-testimonial active">
            ...
            <blockquote>
                "We finally have one place where anyone can answer
                'where's this project at?' — without a meeting."
            </blockquote>
        ...
        <div class="lp-testimonial">
            ...
            <blockquote>
                "The phase rail alone saved us from three status meetings
                a week. It's just always up to date."
            </blockquote>
            ...
            <div class="lp-quote-who">
                ...
                <div class="meta">
                    <div class="n">Team Leader</div>
                    <div class="r">Software Development</div>
                </div>
            </div>
        ...
        <div class="lp-testimonial">
            ...
            <blockquote>
                "I can see exactly what's on my plate and what's overdue
                the second I log in. No more digging through email."
            </blockquote>
            ...
            <div class="lp-quote-who">
                ...
                <div class="meta">
                    <div class="n">Team Member</div>
                    <div class="r">Network &amp; Infrastructure</div>
                </div>
            </div>
        ...
        <div class="lp-testimonial-nav">
            ...
            <button
                class="lp-slider-arrow"
                id="lpTestimonialPrev"
                aria-label="Previous"
                type="button"
            >
...
<section class="lp-section lp-workflow" id="faq">
    ...
    <div class="lp-faq" data-reveal x-data="{ open: 0 }">
        ...
        <div class="lp-faq-item">
            ...
            >
                ...
                <svg
                    ...
                    stroke="currentColor"
                    stroke-width="2"
                    :style="open === 1 && 'transform:rotate(180deg)'"
                >
                    <path d="M6 9l6 6 6-6"/>
                </svg>
            </div>
            ...
            <div
                class="lp-faq-a"
                :style="open === 1 && 'max-height:200px;padding-bottom:18px'"
            >
        ...
        <div class="lp-faq-item">
            ...
            >
                <span>How is my data kept separate from other teams?</span>
                ...
                <svg
                    ...
                    stroke="currentColor"
                    stroke-width="2"
                    :style="open === 2 && 'transform:rotate(180deg)'"
                >
                    <path d="M6 9l6 6 6-6"/>
                </svg>
            </div>
            ...
            <div
                class="lp-faq-a"
                :style="open === 2 && 'max-height:200px;padding-bottom:18px'"
            >
                <div class="lp-faq-a-inner">
                    Projects belong to a team, and your role determines
                    what you can see and edit. Team Members see what's
                    assigned to them; Team Leaders see their team's
                    projects; Directors see everything.
                </div>
            </div>
        ...
        <div class="lp-faq-item">
            ...
            >
                ...
                <svg
                    ...
                    stroke="currentColor"
                    stroke-width="2"
                    :style="open === 3 && 'transform:rotate(180deg)'"
                >
                    <path d="M6 9l6 6 6-6"/>
                </svg>
            </div>
        ...
        <div class="lp-faq-item">
            ...
            >
                <span>Is every action logged?</span>
                ...
                <svg
                    ...
                    stroke="currentColor"
                    stroke-width="2"
                    :style="open === 4 && 'transform:rotate(180deg)'"
                >
                    <path d="M6 9l6 6 6-6"/>
                </svg>
            </div>
            ...
            <div
                class="lp-faq-a"
                :style="open === 4 && 'max-height:200px;padding-bottom:18px'"
            >
                <div class="lp-faq-a-inner">
                    Status changes, approvals, and key edits are written
                    to the audit log automatically, with who made the
                    change and when.
                </div>
            </div>
...
<section class="lp-section" id="about">
    ...
    <div class="lp-cta-banner" data-reveal>
        ...
        <p>
            Ask your System Administrator for an account,
