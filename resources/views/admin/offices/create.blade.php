      ...
      <div class="form-field">
        ...
        <select id="department_id" name="department_id">
          ...
          @foreach ($departments as $department)
            <option value="{{ $department->department_id }}" {{ (string) old('department_id') === (string) $department->department_id ? 'selected' : '' }}>{{ $department->department_name }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-field">
        ...
        <select id="parent_office_id" name="parent_office_id">
          ...
          @foreach ($parentOffices as $parentOffice)
            <option value="{{ $parentOffice->office_id }}" {{ (string) old('parent_office_id') === (string) $parentOffice->office_id ? 'selected' : '' }}>{{ $parentOffice->office_name }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-field">
